...
def test_registry_travel_only():
    ...
    inp.write_text(
        "\n".join([
            ...
            '{"ts":"2025-12-17T21:00:01Z","user_id":"u1","event_type":"login_fail","src_ip":"1.1.1.1","country":"JP","device_id":"d1"}',
            '{"ts":"2025-12-17T21:00:02Z","user_id":"u1","event_type":"login_fail","src_ip":"1.1.1.1","country":"JP","device_id":"d1"}',
            '{"ts":"2025-12-17T21:00:03Z","user_id":"u1","event_type":"login_fail","src_ip":"1.1.1.1","country":"JP","device_id":"d1"}',
            '{"ts":"2025-12-17T21:00:04Z","user_id":"u1","event_type":"login_fail","src_ip":"1.1.1.1","country":"JP","device_id":"d1"}',
        ]) + "\n",
        encoding="utf-8",
    )
    ...
    assert len(lines) == 1, f"expected 1 travel alert, got {len(lines)}"
    assert "RULE_IMPOSSIBLE_TRAVEL" in lines[0], "missing travel rule id"
    assert "RULE_STUFFING_BURST" not in lines[0], "stuffing should be gated off"
    print("OK: registry travel-only gates stuffing off")
